...
///{@template pocketbase_helpers.helper.basehelper}
///The `BaseHelper` is a (slightly) more low level version of the `CollectionHelper` and also used by `CollectionHelper` internally
...
///{@endtemplate}
class BaseHelper {
  ///{@macro pocketbase_helpers.helper.basehelper}
  const BaseHelper({
  ...
  Future<T?> getOneOrNull<T extends Object>(
    ...
    if (record.items.isEmpty) {
      ...
      return mapper(HelperUtils.getRecordJson(record.items.first, expansions));
    }
  }
