...
///{@template pocketbase_helpers.helper.collectionhelper}
...
class CollectionHelper<T extends PocketBaseRecord> {
  ///{@macro pocketbase_helpers.helper.collectionhelper}
  CollectionHelper({
  ...
  ///{@template pocketbase_helpers.helper.expansions}
  ...
  /// {@template pocketbase_helpers.helper.fields}
  ...
  ///(equal to pb.collection(helper.collectionName))
